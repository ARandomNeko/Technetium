        ...
        <div class="container mx-auto xl:px-32">
          <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div class="mt-12 lg:mt-0 py-4">
              <h1 class="typing-title xs:text-xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-1 text-white">Sreenidhi Technetium </h1>
              <h1 class=" text-xl xs:text-xl md:text-5xl xl:text-6xl  tracking-tight font-semibold text-blue-500 mb-1">The first student led hackathon in Hyderabad</h1>
