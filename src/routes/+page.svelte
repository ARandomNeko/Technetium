...
<!-- Sreenidhi Technetium-->
    ...
    <section class=" mt-20 sm:mt-10 md:translate-y-14 mb-48">
      <script> 
        ...
        var flipdown = new FlipDown(1679632200000);
        flipdown.start();
        flipdown.ifEnded(() => {
        ...
        <div class="container mx-auto xl:px-32">
          <div class="items-center">
            <div class="mt-12 lg:mt-0 py-4">
              <h1 class=" text-4xl md:text-6xl xl:text-6xl font-bold tracking-tight mb-1 text-white">Sreenidhi Technetium </h1>
...
<!-- Events -->
    ...
    <div style = "background-image: url('https://wallpapersmug.com/download/1600x900/dbc266/texture-dark-surface.jpg');background-repeat: no-repeat;  background-size: cover;"class="px-6 py-12 md:px-12 bg-black    text-left lg:text-left block rounded-lg shadow-lg">
      <div class="container mx-auto xl:px-32">
        <div class="items-center ">
...
Each team will be working on a single main project to submit to the hackathon judge team for evaluation. You will have about 48 hours to create a functional solution, although it is not necessary for you to implement your entire idea. You will be submitting your project to a single challenge, and the project will be evaluated by the judges who will assign it a score based on a rubric which will be shared with registered participants shortly. 
  ...
  <section class="translate-y-10" data-aos="fade-up">
    <div style = "background-image: url('https://images.unsplash.com/photo-1526289034009-0240ddb68ce3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80 ');background-repeat: no-repeat;  background-size: cover;"class="px-6 py-12 md:px-12 bg-black    text-left lg:text-left block rounded-lg shadow-lg">
      <div class="container mx-auto xl:px-32">
        <div class="items-center ">
          <h1 class="text-4xl md:text-5xl xl:text-6xl  tracking-tight font-bold text-white font-mono mb-4">
            Themes
