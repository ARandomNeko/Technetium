        ...
        <div class="items-center ">
          ...
          <div class="mt-12 lg:mt-0 py-4 grid md:grid-cols-3 ">
            ...
            <div class="glass-content">
              <div class="p-4">
                <h1 class="text-3xl md:text-3xl xl:text-6xl  tracking-tight font-bold text-blue-500 mb-4">
                  Main Problem
                </h1>
                  <p class="text-gray-300">
            ...
            <div class="glass-content max-h-[30rem] ">
              <div class="p-4">
                <h1 class="text-4xl md:text-4xl xl:text-6xl  tracking-tight font-bold text-blue-500 mb-4">
                  Individual Events
                </h1> 
              </div>  
